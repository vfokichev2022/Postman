## Postman HW 2 (additional)

### 1. http://162.55.220.72:5005/user_info_2 (ОБЯЗАТЕЛЬНОЕ И ВАЖНЕЙШЕЕ ЗАДАНИЕ)
...
+ *** Преобразовать два описанные выше задания для данного эндпоинта в ОДИН ЦИКЛ, в котором будут проходить ОБА теста.
